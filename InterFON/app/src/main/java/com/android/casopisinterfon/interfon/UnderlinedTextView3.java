...
public class UnderlinedTextView3 extends TextView {
    private Rect mRect;
    ...
    public UnderlinedTextView3(Context context) {
        this(context, null, 0);
    }

    public UnderlinedTextView3(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UnderlinedTextView3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attributeSet, int defStyle) {
        ...
        mColor = typedArray.getColor(R.styleable.UnderlinedTextView_underlineColor, Color.RED);
